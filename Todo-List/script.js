...
const ulist=document.querySelector('table');
  ...
  screen.addEventListener('keypress', (e) => {
    if (e.which === 13 && screen.value!="") 
    {
        ...
        icon.classList.add("fa","fa-solid","fa-arrow-up");
        console.log(icon);
        td2.append(icon);
        let icon1=document.createElement('i');
        icon1.classList.add("fa","fa-solid","fa-times");
        console.log(icon1);
        td3.append(icon1);
        let icon2=document.createElement('i');
        icon2.classList.add("fa","fa-solid","fa-comment-alt-edit");
        console.log(icon2);
        td4.append(icon2);

        let icon3=document.createElement('i');
        icon3.classList.add("fa","fa-solid","fa-arrow-down");
        console.log(icon3);
        td5.append(icon3);
